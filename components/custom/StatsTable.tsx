...
const StatsTable = ({ stats, isBtech }: { stats: StatsFormProps[], isBtech:boolean }) => {
            ...
            return (
              <TableRow key={index}>
                ...
                <TableCell>
                  {
                   stat.medianpackage ? 
                  `${stat.medianpackage} ${stat.medianpackageunit.toUpperCase()}` : <span className='text-red-400'>N/A</span>
                }
                </TableCell>
                <TableCell>
               ...
               <TableCell>
                  {stat.highestpackageoffcampus ? `${stat.highestpackageoffcampus} 
                  ${stat.highestpackageoffcampusunit.toUpperCase()}` : <span className='text-red-400'>N/A</span>}
                </TableCell>
                <TableCell>{stat.noofcompaniesvisited ? stat.noofcompaniesvisited : <span className='text-red-400'>N/A</span>}</TableCell>
                ...
                <TableCell>
                  <div className="flex gap-4">
                    ...
                    >
                      <Link href={ isBtech ? `/btech_statistics/${stat._id}` :  `/mtech_statistics/${stat._id}`}>Edit</Link>
                    </Button>
                    <Button
                      size={'sm'}
                      variant={'destructive'}
